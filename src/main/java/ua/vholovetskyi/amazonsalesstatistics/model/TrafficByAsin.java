...
public class TrafficByAsin {
    ...
    public int browserPageViewsPercentageB2B;
    public double mobileAppPageViewsPercentage;
    public int mobileAppPageViewsPercentageB2B;
    public double pageViewsPercentage;
    public int pageViewsPercentageB2B;
    public int buyBoxPercentage;
    public int buyBoxPercentageB2B;
    public double unitSessionPercentage;
    public int unitSessionPercentageB2B;
}
